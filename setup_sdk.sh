...
echo ""
echo "ℹ️  Note: The build.sh script will automatically set up the Python environment"
echo "   and install 'west' when you run it for the first time."
echo ""
echo "You can now run the ZMK build script: ./build.sh"